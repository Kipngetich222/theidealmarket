...
//       className="bg-gradient-to-r from-primary-500 to-primary-700 rounded-lg shadow-lg overflow-hidden"
//     >
...
//             className="flex-1 flex items-center justify-center bg-white/20 hover:bg-white/30 py-2 px-4 rounded-lg transition duration-200"
//           >
      ...
      <div className="p-6 text-white">
        <div className="flex justify-between items-start">
          <div>
            ...
            <p className="text-xs opacity-80 mt-1">+ $250.00 this week</p>
          </div>
          <div className="bg-white/20 p-3 rounded-full">
            <FiDollarSign className="h-6 w-6" />
          </div>
